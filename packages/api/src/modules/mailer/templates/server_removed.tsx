...
export function Subject(ctx: { serverId?: string }) {
  return `Hullbay — serveur supprimé (${ctx.serverId ?? "N/A"})`
}
    ...
    <html>
      <body style={{ fontFamily: "Arial, sans-serif", color: "#111827", lineHeight: 1.6 }}>
        <div style={{ maxWidth: 560, margin: "0 auto", padding: 24 }}>
          <h1 style={{ marginBottom: 12, fontSize: 28, color: "#111827" }}>Serveur supprimé</h1>
          <p>Bonjour,</p>
          <p>Le serveur a été supprimé de Hullbay.</p>
          ...
          <p>Cette action est définitive et peut affecter les accès ou services associés.</p>
        </div>
      </body>
    </html>
  )
